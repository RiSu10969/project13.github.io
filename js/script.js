...
$('#chart01').on('inview', function (event, isInView) {//画面上に入ったらグラフを描画
	if (isInView) {
		...
		var chart = new Chart(ctx, {
			type: 'pie',//グラフのタイプ
			data: {//グラフのデータ
				labels: ["シマちゃん", "アナゴブラザーズ", "山田エゾ氏", "もぐ郎", "イイズナ", "メンダコと雪うさぎ",],//データの名前
				datasets: [{
					label: "人気キャラクターランキング",//グラフのタイトル
					backgroundColor: ["#05c3c5", "#059ac5", "#0576c5", "#0556c5", "#A9CEEC", "#AFDFE4",],//グラフの背景色
					data: ["7", "5", "6", "7", "3", "4"]//データ
				}]
			},
